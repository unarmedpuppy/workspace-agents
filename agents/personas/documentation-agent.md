...
- Add missing YAML frontmatter to skills, personas, and plans
...
1. **YAML Frontmatter Required**
   - All skills must have frontmatter in SKILL.md: `name`, `description`
   - All personas must have frontmatter: `name`, `description`
   - All plans should have frontmatter: `title`, `created`, `status`

2. **File Naming Conventions**
   - Skills: `agents/skills/<skill-name>/SKILL.md` (hyphen-case)
   - Personas: `agents/personas/<domain>-agent.md` (hyphen-case with -agent suffix)
   - Plans: `agents/plans/<feature-name>.md` (hyphen-case)
...
2. **P0**: Incorrect skill structure
...
- One category at a time (P0 -> P1 -> P2)
...
- [agents/reference/skill-patterns.md](../reference/skill-patterns.md) - Skill documentation patterns
