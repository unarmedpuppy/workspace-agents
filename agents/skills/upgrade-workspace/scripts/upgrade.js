...
/**
 * upgrade.js - Main orchestrator for upgrade-workspace skill
 * 
...
// Reuse create-symlinks from scaffold-workspace
const createSymlinks = require('../../scaffold-workspace/scripts/create-symlinks');
...
async function upgrade(projectRoot = process.cwd(), options = {}) {
  ...
  if (!fs.existsSync(agentsDir)) {
    ...
    console.error(chalk.yellow('   Use scaffold-workspace skill to create a new framework.'));
    process.exit(1);
  }
