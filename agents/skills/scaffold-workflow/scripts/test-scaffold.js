...
/**
 * test-scaffold.js - Dry-run test for scaffold-workflow
 * 
...
async function runTests() {
  console.log(chalk.bold.blue('🧪 Testing scaffold-workflow (dry-run mode)\n'));
...
async function testCleanScaffold(testDir) {
  ...
  console.log(chalk.gray('    - .claude/skills/scaffold-workflow → ../../agents/skills/scaffold-workflow'));
  console.log(chalk.gray('    - .claude/skills/upgrade-workflow → ../../agents/skills/upgrade-workflow'));
...
async function testExistingAgentsDir(testDir) {
  ...
  console.log(chalk.gray('Scaffold should detect this and recommend upgrade-workflow instead'));
  
  console.log(chalk.green('  ✓ Would detect existing agents/ directory'));
  console.log(chalk.green('  ✓ Would suggest: Use upgrade-workflow skill instead'));
